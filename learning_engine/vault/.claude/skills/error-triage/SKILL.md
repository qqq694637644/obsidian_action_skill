---
name: error-triage
description: Capture a new learning mistake quickly or batch-analyse #unanalyzed entries in "00 - Error Log.md" — classify errors, find root causes and prerequisite gaps, prescribe fixes, and update weak-spot trackers. Use when the user asks to record/log a wrong answer, triage errors, analyse mistakes, or identify learning gaps.
---
...
Run engine commands as `Set-Location vault; python log_error.py ...`, and use
`vault/00 - Error Log.md` for Workspace file Actions. If the user only asks to
record a mistake, capture it and stop; do not force a full triage pass.
